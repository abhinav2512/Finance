...
st.title('MUTUAL FUND TREND ANALYSIS')
user_input = st.text_input('Enter Mutual Fund Ticker' , 'JEQIX')
...
df1year = df.iloc[-261:]
macd1year = macd.iloc[-261:]
signal1year = signal.iloc[-261:]
